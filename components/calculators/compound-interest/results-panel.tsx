...
import { TrendingUp, Receipt, Wallet, Landmark, Repeat } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <MetricCard
          ...
          tone="neutral"
          tooltip="Ganancia total antes de aplicar la retención fiscal, generada por la capitalización compuesta del interés."
        />
        <MetricCard
      ...
      {/* Gráfico de desglose: capital inicial + intereses netos = capital final neto */}
      ...
      <div className="rounded-xl bg-muted/50 px-4 py-3.5">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-1.5">
            ...
            <InfoTooltip text="La rentabilidad anual real teniendo en cuenta el efecto de la capitalización compuesta. Suele ser algo mayor que el TIN nominal cuanto más frecuente es la capitalización." />
          </div>
